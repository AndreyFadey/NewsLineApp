...
import com.newslineapp.util.Constants.Companion.SEARCH_NEWS_TIME_DELAY
...
class SearchNewsFragment: Fragment(R.layout.fragment_search_news) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var job: Job? = null
        etSearch.addTextChangedListener{ Editable ->        //устанавливаем заддержку между окончанием ввода и началом поиска
            job?.cancel()
            ...
            when(response){
                is Resource.Success -> {
                    ...
                    response.data?.let { newsResponse ->
                        ...
                        val totalPages = newsResponse.totalResults / Constants.QUERY_PAGE_SIZE + 2 //убираем пустые страницы из просмотра
